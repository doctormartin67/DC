...
typedef enum {KEY, NOREGLEMENT, NAAM, CONTRACT, STATUS, ACTIVECONTRACT, SEX,
	...
	TARIEF, KO, RENTINV, CONTRINV, ART24_A_GEN1, ART24_A_GEN2,
	ART24_C_GEN1, ART24_C_GEN2, PREMIUM, CAP, CAPPS, CAPDTH, RES, RESPS,
	CAPRED, TAUX, DELTA_CAP_A_GEN1, DELTA_CAP_C_GEN1, X10, CAO, ORU,
	CHOICEDTH, CHOICEINVS, CHOICEINVW, CONTRD, PERCOFSALFORKO,
	INVINDEXATION, GRDGR, PLAN, BARANC, INCSALFIRSTYEAR, PREP,
	KEYS_AMOUNT = 1024
} DataColumn;
